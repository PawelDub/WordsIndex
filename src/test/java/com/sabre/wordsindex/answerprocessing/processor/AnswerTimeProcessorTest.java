...
@DisplayName("Test of processing times from answer text")
public class AnswerTimeProcessorTest {
    private final static String INPUT_TEXT = "\t\t11:16:60\t11:6:56//1:14:18//: ąśń---///...A16.07.2056la-2 23:60 24:18 00:00 00:01 19:18 19:18 19:17:17 19:17:17 " +
    ...
    void shouldReturnSortedTimeCollection() {
        ...
        Set<String> splitAnswer = answerTimeProcessor.collectWordsFrom(INPUT_TEXT);
        assertThat(splitAnswer).isEqualTo(new TreeSet<>(Arrays.asList( "00:00", "00:01", "02:23", "16:15:59", "19:17:17", "19:18")));

        Mockito.verify(answerTimeProcessor, times(1)).processAnswer(INPUT_TEXT);
    }
    ...
    void shouldBuildIndexedCollectionOfDatesCorrectly() {
        ...
        Map<String, Set<String>> splitAnswer = answerTimeProcessor.buildIndexedWordsCollection(INPUT_TEXT);
        ...
        Mockito.verify(answerTimeProcessor, times(1)).collectWordsFrom(INPUT_TEXT);
        Mockito.verify(answerTimeProcessor, times(1)).processAnswer(INPUT_TEXT);
    }
