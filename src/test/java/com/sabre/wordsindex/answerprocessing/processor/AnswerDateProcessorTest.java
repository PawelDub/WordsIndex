...
public class AnswerDateProcessorTest {
    ...
    private final static String INPUT_TEXT = "\t\t\t////:-31.12.2019 ąśń13.02.2018 30.02.2019 32.12.2018 31.13.2017 31-04-2017 13.12.1955---///...A16.07.2056la-2 " +
    ...
    void shouldReturnSortedDatesCollection() {
        ...
        Set<String> splitAnswer = answerDateProcessor.collectWordsFrom(INPUT_TEXT);
        ...
        Mockito.verify(answerDateProcessor, times(1)).processAnswer(INPUT_TEXT);
    }

    @DisplayName("Should build indexed collection of dates correctly")
    @Test
    void shouldBuildIndexedCollectionOfDatesCorrectly() {
        Map<String, Set<String>> splitAnswer = answerDateProcessor.buildIndexedWordsCollection(INPUT_TEXT);
        ...
        Mockito.verify(answerDateProcessor, times(1)).collectWordsFrom(INPUT_TEXT);
        Mockito.verify(answerDateProcessor, times(1)).processAnswer(INPUT_TEXT);
    }
